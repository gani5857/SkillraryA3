...
public class WebDriverUtility {
	...
	/**
	 * This element waits until element is enabled to click
	 * @param time
	 * @param element
	 */
	...
	/**
	 * This is used to select an element from drop down based on index
	 * @param element
	 * @param index
	 */
	...
	/**
	 * This method is used select an element from drop down on value
	 * @param element
	 * @param value
	 */
	 ...
	 * @param frameElement
	 */
	public void switchBackFromFrame(WebElement frameElement)
	{
	...
	/**
	 * This method fetches the parent window address
	 * @return
	 */
	...
	/**
	 * This method is used to close all the tabs windows
	 */
